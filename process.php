...
if($_POST) //Post Data received from product list page.
{
	...
	$TotalTaxAmount 	= 0.30;  //Sum of tax for all items in this order. 
	...
	$padata = 	'&METHOD=SetExpressCheckout'.
				...
				'&LOGOIMG=http://localhost/Ecom/css/images/logoa.png'. //site logo
			...
			echo 'Your Transaction ID : '.urldecode($httpParsedResponseAr["PAYMENTINFO_0_TRANSACTIONID"]);
				...
				*/
				...
				elseif('Pending' == $httpParsedResponseAr["PAYMENTINFO_0_PAYMENTSTATUS"])
				{
					...
					'You need to manually authorize this payment in your <a target="_new" href="https://www.sandbox.paypal.com">Paypal Account</a></div>';
				}
/*
				...
				if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) 
				{
					...
					$ItemName = urldecode($httpParsedResponseAr["NAME"]);
					
					$ItemNumber = urldecode($httpParsedResponseAr["NUMBER"]);
					
					$ItemTotalPrice = urldecode($httpParsedResponseAr["AMT"]);
					$ItemQTY = urldecode($httpParsedResponseAr["QTY"]);
