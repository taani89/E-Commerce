...
<body>
		...
		<div id="main">
			...
			<div class="shell">
				...
				<div id="header">
					...
					<div id="navigation">
						<ul>
						    <li><a href="#" class="active" title="Laptops"><span>Laptops</span></a></li>
						    <li><a href="smartphones.php" title="Smartphones"><span>Smartphones</span></a></li>
						</ul>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
				...
				<div id="main-slider">
					<div id="slider-holder">
						<ul>
						    <li>
					    	<img src="css/images/clevo-laptopdeals.jpg" alt="Slider Image 1" /></li>
						    <li>
						    	<img src="css/images/laptop-hero.png" alt="Slider Image 1" />
						    </li>
						    <li>
						    	<img src="css/images/it_photo_210586.jpg" alt="Slider Image 1" />
	...
	$results = $mysqli->query("SELECT * FROM products WHERE product_code LIKE '%PDI%' ORDER BY id ASC");
    if ($results) { 
